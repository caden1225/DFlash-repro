...
class DataConfig:
    ...
    dataset_name: str = "lmsys/sharegpt_jsonl"
...
class DFlashConfig:
    ...
    def resolve_auto_fields(self, num_target_layers: Optional[int] = None) -> None:
        ...
        """
        # Resolve target_layer_ids when layer count is known (e.g. after loading
        # the target model). Otherwise leave None for the training entry point.
        if self.model.target_layer_ids is None and num_target_layers is not None:

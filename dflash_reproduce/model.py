...
def build_draft_model(
    ...
    """
    # Infer hidden_size from target config if available
    if target_config is not None and hasattr(target_config, "hidden_size"):
        config.hidden_size = target_config.hidden_size
        # Re-validate head_dim
    ...
    projection_out_features = config.hidden_size
